...
<div class="container" style="position: relative; margin-left: 20% ; width:58%; " >
 ...
 <div class="card" style="width: 100%; position: relative; " >
  <div class="card-body">
    <h2 class="card-title text-center">Categoria: <?= $_GET['nome']; ?></h2>
      <?php 
     $url = URL; 
     $idCategoria = $_GET['idCategoria']; 
     $nome = $_GET['nome'];    
   if(isset($_SESSION['idPessoa'])){ 
     if($this->dados['seguindo']==1){  
         echo" <a href='$url/home/categoria?idCategoria=$idCategoria&nome=$nome&desseguir=1'> <button id='botao' type='button' class='btn btn-dark'  style='float: right'> Deixar de seguir categoria</button></a>" ;  } 
     else {
        echo " <a href='$url/home/categoria?idCategoria=$idCategoria&nome=$nome&seguir=1'> <button id='botao' style='float: right'type='button' class='btn btn-primary' > Seguir categoria </button></a>";  } 
