...
<body class="text-center">
  <div class="row justify-content-md-center" style="margin-top: 100px">
    <form class="form-signin" method="post" action="">
        <img class="mb-4" src="<?= URL;?>assets/img/icon/logo.png" alt="" width="150" height="150">
        ...
        <input type="text" class="form-control" name="email" id="iUser" value="<?= $email; ?>"
        ...
        <button class="btn btn-sm btn-primary btn-block mt-1" name="sendLogin" type="submit">Logar</button>
